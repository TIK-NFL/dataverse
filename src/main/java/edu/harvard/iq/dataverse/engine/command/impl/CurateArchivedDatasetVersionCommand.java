...
public class CurateArchivedDatasetVersionCommand extends AbstractDatasetCommand<Dataset> {

    private static final Logger logger = Logger.getLogger(CurateArchivedDatasetVersionCommand.class.getCanonicalName());
    final private boolean validateLenient = false;

    public CurateArchivedDatasetVersionCommand(Dataset theDataset, DataverseRequest aRequest) {
